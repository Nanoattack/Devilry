...
public class AlchemyStationContainer extends Container
{
    ...
    public AlchemyStationContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player)
    {
        super(ModContainers.ALCHEMY_STATION_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(PlayerEntity playerIn)
    {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(),
                tileEntity.getBlockPos()), playerEntity, ModBlocks.ALCHEMY_STATION.get());
    }
